...
<body>
  <div class="container">
    ...
    <form class="form-signin" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
      Validate Your Number: <input type="tel" class="form-control" pattern="[+]{1}[9]{1}[1]{1}[0-9]{10}" maxlength="13" name="phone" onkeydown="this.value = this.value.trim()" onkeyup="this.value = this.value.trim()" placeholder="Enter +91 before your number" id="" autofocus>
      <br>
      <input class="btn w-100 btn-lg btn-primary btn-block" type="submit" name="submit" value="Submit">
    </form>

    <ul class="pagination pagination-md justify-content-center">
    <li class="page-item"><a class="page-link" href="./photo_upload.php">Prev</a></li>
      ...
      <li class="page-item active"><a class="page-link" href="./mobile.php">3</a></li>
      ...
      <li class="page-item"><a class="page-link" href="./mail.php">Next</a></li>
  ...
  <div class="container form-signin">
    ...
    function validate_number($number)
    {
      ...
      if (preg_match('/^\+[9]{1,2}[1]{1}[0-9]{10}$/', $number)) {
        ...
        // return "enter valid number along with correct country code";
      }
    }
